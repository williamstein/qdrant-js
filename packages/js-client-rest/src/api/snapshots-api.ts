...
export function createSnapshotsApi(client: Client) {
    return {
         ...
         */
        createFullSnapshot: withFieldsMask(client.path('/snapshots').method('post').create({wait: true})),
         ...
         */
        deleteFullSnapshot: withFieldsMask(
            client.path('/snapshots/{snapshot_name}').method('delete').create({wait: true}),
        ),
         ...
         */
        getFullSnapshot: withFieldsMask(client.path('/snapshots/{snapshot_name}').method('get').create()),
         ...
         */
        listFullSnapshots: withFieldsMask(client.path('/snapshots').method('get').create()),
